...
또한 해그리드 씨의 오두막 근처로 몰래 빠져나가려다 필치 씨에게 적발될 경우, 기숙사 점수가 크게 깎일 수 있으니 주의 바랍니다!`
  ...
  "슬리데린": {
    title: "위대한 야망의 시작, 그리고 슬러그 클럽 가입의 기회!",
    content: `이번 주 우리 기숙사에 합류한 신입생 여러분, 환영합니다. 여러분은 호그와트에서 가장 대담하고 실리적인 이들이 모인 슬리데린의 일원이 되었습니다.

지금 온 성안이 사냥터지기 오두막에 있는 용의 알 이야기로 떠들썩합니다. 다른 기숙사 애들이 얄팍한 호기심에 들떠 있을 때, 우리 슬리데린은 그 이면에 숨겨진 강력한 마법적 가치와 힘에 주목해야 합니다. 용은 힘과 권위의 상징이며, 그 부화 과정을 지켜보는 것은 마법사로서 흔치 않은 기회입니다.
